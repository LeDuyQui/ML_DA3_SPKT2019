...
print(gaus)
predicting_label = gaus.predict(X_test)
print("Accuracy: ", (metrics.accuracy_score(Y_test, predicting_label))*100)
print(metrics.classification_report(Y_test, predicting_label))
...
# # CrossValidation
# gaus = GaussianNB()
# cv_scores = cross_val_score(gaus, X_train, Y_train, cv=5)
