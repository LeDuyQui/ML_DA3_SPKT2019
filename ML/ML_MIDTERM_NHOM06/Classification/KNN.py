...
# chay voi du lieu binh thuong, khong su dung tham so cua KNN
# knn = KNeighborsClassifier(n_neighbors=15)
# knn.fit(X_train,Y_train)
# predicting_label = knn.predict(X_test)
# print(confusion_matrix(Y_test,predicting_label))
# print(classification_report(Y_test,predicting_label))
# print("Accuracy Normal: ", metrics.accuracy_score(Y_test,predicting_label))
...
# print(confusion_matrix(Y_test,predicting_label))
# print(classification_report(Y_test,predicting_label))
# print("Accuracy distance: ", metrics.accuracy_score(Y_test,predicting_label))
...
# print(confusion_matrix(Y_test,predicting_label))
# print(classification_report(Y_test,predicting_label))
# print("Accuracy uniform: ", metrics.accuracy_score(Y_test,predicting_label))

# # chay voi algorithm
# knn = KNeighborsClassifier(n_neighbors=15, algorithm='ball_tree')
# knn.fit(X_train,Y_train)
# predicting_label = knn.predict(X_test)
# # print(confusion_matrix(Y_test,predicting_label))
# # print(classification_report(Y_test,predicting_label))
# print("Accuracy ball_tree: ", metrics.accuracy_score(Y_test,predicting_label))
...
# # print(confusion_matrix(Y_test,predicting_label))
# # print(classification_report(Y_test,predicting_label))
# print("Accuracy brute: ", metrics.accuracy_score(Y_test,predicting_label))
...
# # print(confusion_matrix(Y_test,predicting_label))
# # print(classification_report(Y_test,predicting_label))
# print("Accuracy kd_tree: ", metrics.accuracy_score(Y_test,predicting_label))
# # veplot
# fig = plt.figure()
